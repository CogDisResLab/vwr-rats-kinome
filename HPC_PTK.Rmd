---
title: "Exercise Project - PTK - Hippocampus"
...
krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("HPC_CTL", "HPC_Exer"))

ggsave("figures/HPC_PTK_Violin-Plots.svg", width = 11, height = 8.5, plot = {krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("HPC_CTL", "HPC_Exer"))})
```
...
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("HPC_CTL", "HPC_Exer"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
pdf("figures/HPC_PTK_Heatmap.pdf", width = 8.5, height = 11)
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("HPC_CTL", "HPC_Exer"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
