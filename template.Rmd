---
title: "Neuron Fingerprint - STK"
subtitle: "Nicholas Henkel"
...
params:
  ...
  signal_file: "kinome_data/_KRSAsOutput_Median_SigmBg_230103164304.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/_KRSAsOutput_Signal_Saturation_230103164304.txt" # Change the file name to the one you have
...
comparisons <- list(COMP1 = c(groups[1], groups[4]),
