---
title: "Exercise Project - STK - Hippocampus"
...
krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("CTL_HPC", "Exer_HPC"))

ggsave("figures/HPC_STK_Violin-Plots.svg", width = 11, height = 8.5, plot = {krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("CTL_HPC", "Exer_HPC"))})
```
...
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("CTL_HPC", "Exer_HPC"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)

svg("figures/HPC_STK_Heatmap.svg", width = 8.5, height = 11)
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("CTL_HPC", "Exer_HPC"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
...
comparisons <- list(COMP1 = c(groups[4], groups[2]))
```
