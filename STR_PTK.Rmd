---
title: "Exercise Project - PTK - Striatum"
...
params:
  ...
  signal_file: "kinome_data/PTK_ExportstosDB_Median_SigmBg_200716215555.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/PTK_ExportstosDB_Signal_Saturation_200716215557.txt" # Change the file name to the one you have
...
krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("STR_CTL", "STR_Exer"))

ggsave("figures/HPC_PTK_Violin-Plots.svg", width = 11, height = 8.5, plot = {krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("STR_CTL", "STR_Exer"))})
```
...
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("STR_CTL", "STR_Exer"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
svg("figures/HPC_PTK_Heatmap.svg", width = 8.5, height = 11)
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("STR_CTL", "STR_Exer"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
...
-   Exercise Hippocampus vs Control Hippocampus
...
comparisons <- list(COMP1 = c(groups[4], groups[3]))
```
