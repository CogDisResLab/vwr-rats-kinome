...
ggsave("figures/STR_PTK_Violin-Plots.svg", width = 11, height = 8.5, plot = {krsa_violin_plot(data_modeled$scaled, clean_peptides, "Barcode", groups = c("STR_CTL", "STR_Exer"))})
```
...
dev.off()
pdf("figures/STR_PTK_Heatmap.pdf", width = 8.5, height = 11)
krsa_heatmap(data_modeled$normalized, clean_peptides, scale = "row", groups = c("STR_CTL", "STR_Exer"), cluster_rows = TRUE, cluster_cols = FALSE, treeheight_row = 0)
dev.off()
